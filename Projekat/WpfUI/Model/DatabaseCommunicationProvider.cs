...
namespace WpfUI.Model
{
    public class DatabaseCommunicationProvider
    {
        ...
        internal void AddBrodToLinija(Guid brodId, Guid brojLinije) => proxy.AddBrodToLinija(brodId, brojLinije);
        ...
        internal bool RemovePosada(Guid id) => proxy.RemovePosada(id);
        ...
        internal bool RemoveKruzer(Guid id) => proxy.RemoveKruzer(id);
        internal bool RemoveTanker(Guid id) => proxy.RemoveTanker(id);
        ...
        internal bool RemoveTeretniBrod(Guid id) => proxy.RemoveTeretniBrod(id);
        internal BrodskaLinija GetBrodskaLinija(Guid id) => proxy.GetBrodskaLinija(id);
        internal bool RemoveKapetan(string jmbg) => proxy.RemoveKapetan(jmbg);
        internal void EditTeretniBrod(TeretniBrod teretniBrod) => proxy.EditTeretniBrod(teretniBrod);
        internal bool RemoveBrod(Guid id) => proxy.RemoveBrod(id);
        ...
        internal bool RemoveBrodskaLinija(Guid id) => proxy.RemoveBrodskaLinija(id);
        ...
        internal bool RemoveMornar(string jmbg) => proxy.RemoveMornar(jmbg);
        internal void EditBrodskaLinija(BrodskaLinija brodskaLinija) => proxy.EditBrodskaLinija(brodskaLinija);
        internal bool RemoveKormilar(string jmbg) => proxy.RemoveKormilar(jmbg);
        ...
        internal bool RemoveBrodogradiliste(Guid idBrodogradililste) => proxy.RemoveBrodogradiliste(idBrodogradililste);
